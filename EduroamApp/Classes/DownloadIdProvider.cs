...
namespace EduroamApp
{
	class DownloadIdProvider
	{
		...
		/// </summary>
		/// <exception cref="WebException">description</exception>
		/// <exception cref="JsonReaderException">description</exception>
		public static List<IdentityProvider> GetAllInstitutions()
		{
